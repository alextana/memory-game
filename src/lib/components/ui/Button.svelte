	...
	onMount(() => {
		...
		switch (type) {
			...
			case 'tertiary':
				...
				break;
			case 'cta':
				classToUse = `${baseClass} text-white bg-transparent border-2 border-white hover:bg-white font-bold uppercase text-md py-2 px-8 hover:text-black rounded-full`;
				break;
			default:
